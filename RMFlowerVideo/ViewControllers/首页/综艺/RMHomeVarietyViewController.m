...
@interface RMHomeVarietyViewController ()<RMHomeTableViewCellDelegate,RMAFNRequestManagerDelegate>{
...
- (void)refreshControlBeginPullToRefresh{
    ...
    [requestManeger getSlideListWithVideo_type:@"3"];
}
...
- (void)refreshControlBeginDropDownLoad{
    ...
    pageCount++;
    [self showLoadingSimpleWithUserInteractionEnabled:YES];
    [requestManeger getIndexVideoListWithVideoTpye:@"3" searchPageNumber:[NSString stringWithFormat:@"%ld",(long)pageCount] andLimit:@""];
}
