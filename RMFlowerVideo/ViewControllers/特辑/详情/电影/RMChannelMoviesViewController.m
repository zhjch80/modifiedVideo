...
@interface RMChannelMoviesViewController ()<UITableViewDelegate,UITableViewDataSource,VideoOrStarCellDelegate,RMAFNRequestManagerDelegate,RefreshControlDelegate>{
...
@implementation RMChannelMoviesViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.firstBtn setBackgroundColor:[UIColor colorWithRed:0.85 green:0.85 blue:0.85 alpha:1]];
    [cell.firstBtn setTitle:@"播放" forState:UIControlStateNormal];
    ...
    if (indexPath.row * 3 + 1 >= [dataArr count]){
        ...
        [cell.secondBtn setBackgroundColor:[UIColor colorWithRed:0.85 green:0.85 blue:0.85 alpha:1]];
        [cell.secondBtn setTitle:@"播放" forState:UIControlStateNormal];
    }
    ...
    if (indexPath.row * 3 + 2 >= [dataArr count]){
        ...
        [cell.thirdBtn setBackgroundColor:[UIColor colorWithRed:0.85 green:0.85 blue:0.85 alpha:1]];
        [cell.thirdBtn setTitle:@"播放" forState:UIControlStateNormal];
    }
    return cell;
}
...
- (void)startRequest {
    ...
    [manager getVideoListWithTagId:self.tag_id Video_type:@"1" Page:[NSString stringWithFormat:@"%ld",(long)pageCount]];
}
