...
@interface RMChannelVarietyViewController ()<UITableViewDataSource,UITableViewDelegate,VideoOrStarCellDelegate,RMAFNRequestManagerDelegate,RefreshControlDelegate>{
...
@implementation RMChannelVarietyViewController
...
- (void)startRequest {
    ...
    [manager getVideoListWithTagId:self.tag_id Video_type:@"3" Page:[NSString stringWithFormat:@"%ld",(long)pageCount]];
}
