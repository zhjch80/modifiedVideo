...
- (void)setImagesDeselected:(NSString *)deselectedImage
	...
	[s2 setFrame:CGRectMake(SpaceValue + width,     0, width, height)];
	[s3 setFrame:CGRectMake(2*SpaceValue + 2 * width, 0, width, height)];
	[s4 setFrame:CGRectMake(3*SpaceValue + 3 * width, 0, width, height)];
	[s5 setFrame:CGRectMake(4*SpaceValue + 4 * width, 0, width, height)];
